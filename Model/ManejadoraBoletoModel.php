    ...
    public static function getBoleto($id)
    {
        ...
        if ($valid === true || $id == null) {
            $query = "SELECT " . \ConstantesDB\ConsBoletos::id_sorteo . ","
                ...
                . \ConstantesDB\ConsBoletos::premio . ","
                . \ConstantesDB\ConsBoletos::numeroAcertados . " FROM "
                . \ConstantesDB\ConsBoletos::TABLE_NAME;


            if ($id != null) {
                $query = $query . " WHERE " . \ConstantesDB\ConsBoletos::id_boleto . " = ?";
            }
